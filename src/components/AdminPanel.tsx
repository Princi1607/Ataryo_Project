...
const AdminPanel: React.FC<AdminPanelProps> = ({ onClose }) => {
  const { content, updateContent, uploadImage, loading, error } =
    useContentStore();
  ...
  const [imageManagerConfig, setImageManagerConfig] = useState<{
    section: string;
    field: string;
    title: string;
    currentImage?: string;
  ...
  const handleImageUpload = (
    ...
    const currentImage = editingContent[section]?.[field] || "";
  ...
  const handleImageSelect = (imageUrl: string) => {
    if (imageManagerConfig) {
      setEditingContent((prev: any) => ({
        ...prev,
        [imageManagerConfig.section]: {
          ...prev[imageManagerConfig.section],
          [imageManagerConfig.field]: imageUrl,
        },
      }));
    }
    setShowImageManager(false);
    setImageManagerConfig(null);
  };
  ...
  const removeArrayItem = (
    ...
    setEditingContent((prev: any) => ({
      ...
      [section]: {
        ...prev[section],
        [arrayField]: prev[section][arrayField].filter(
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-7xl max-h-[95vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-2xl font-bold text-[#0A5737]">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="flex items-center space-x-2 text-sm text-gray-600 hover:text-red-600 transition-colors px-3 py-1 rounded-md hover:bg-gray-100"
              title="Logout"
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleTextChange("hero", "description", e.target.value)
                      }
                      rows={4}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTextChange("hero", "ctaText1", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTextChange("hero", "ctaText2", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleTextChange("about", "mission", e.target.value)
                        }
                        rows={2}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                      />
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleTextChange("about", "vision", e.target.value)
                        }
                        rows={2}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleTextChange("about", "statValue", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleTextChange("about", "statLabel", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-2 bg-[#0A5737] text-white px-4 py-2 rounded-md hover:bg-[#067141] transition-colors w-full justify-center"
                      >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTextChange("products", "title", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTextChange("products", "subtitle", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                    />
                  </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button
                        onClick={() =>
                          addArrayItem("products", "applications", {
                            title: "",
                            description: "",
                            icon: "Shirt",
                          })
                    ...
                    {editingContent.products.applications?.map(
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTextChange("contact", "title", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTextChange("contact", "subtitle", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A5737]"
                    />
                  </div>
            ...
            {!["hero", "about", "products", "contact"].includes(activeTab) && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  This section editor is coming soon. For now, you can edit the
                  basic sections.
                </p>
                <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded">
                  Advanced editing for this section will be available in the
                  next update.
                </div>
              </div>
            )}
        ...
        {/* Image Manager Modal */}
        {showImageManager && imageManagerConfig && (
          <ImageManager
            currentImage={imageManagerConfig.currentImage}
            onImageSelect={handleImageSelect}
            onClose={() => {
              setShowImageManager(false);
              setImageManagerConfig(null);
            }}
            title={imageManagerConfig.title}
          />
        )}
      </div>
    </div>
